  ...
  <section id="skills" className="py-24 bg-card/50">
    <div className="container">
      <div className="text-center mb-16">
        <span className="text-primary text-sm font-medium tracking-wider uppercase">Core Skills</span>
      ...
      <div className="max-w-2xl mx-auto mb-12">
        <h3 className="text-center text-lg font-semibold mb-6 text-foreground">Frontend Toolkit</h3>
